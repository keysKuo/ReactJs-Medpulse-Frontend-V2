        ...
        <section className="w-full flex flex-col relative justify-center items-center bg-gradient-to-r from-[#e8d6ff99] from-[3.6%] to-[#ffffff99] to-[59.82%]">
            <div className="xl:w-[1180px] w-full flex xl:flex-row flex-col xl:gap-[42px] gap-[20px] py-[51px] xl:px-0 px-[16px]">
                <img
                    ...
                    alt="bgImage"
                    className="absolute top-7 left-0 opacity-40 mix-blend-screen"
                    height={180}
                    width={381}
                />
                <img
                    src={heroBannerImage.logoBlend}
                    alt="bgImage"
                    className="absolute bottom-10 right-0 opacity-70 mix-blend-screen"
                    width={320}
                    height={151}
                />
                <img
                    ...
                    alt="bgImage"
                    className="absolute top-[377px] left-[54px] opacity-10 mix-blend-screen sm:w-[604px] sm:h-[137px] w-[157px] h-[36px]"
                    width={604}
                    height={137}
                />
