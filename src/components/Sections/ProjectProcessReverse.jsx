import { lineImage, processImage, lineImageMobile } from '../../assets/home';
        ...
        <section className="w-full flex flex-col justify-center items-center py-[30px]">
            <div className="xl:w-[1180px] w-full flex xl:flex-row-reverse flex-col justify-between relative items-center sm:gap-[86px] gap-[30px] xl:px-0 px-4">
                ...
                <img
                    src={lineImage}
                    alt="line"
                    className="absolute sm:block hidden xl:left-0 xl:bottom-1/2 bottom-0 xl:translate-y-1/2 -translate-y-12 xl:-translate-x-5"
                />
                <img
                    src={lineImage}
                    alt="line"
                    className="absolute sm:hidden block sm:h-[330px] h-[255px] sm:w-[450px] w-[375px] xl:right-0 xl:bottom-1/2 bottom-0 xl:translate-y-1/2 -translate-y-12 xl:translate-x-5"
                />
